resource "azurerm_virtual_machine_scale_set" "user15vmss1" {
name = "user15vmss1"
...
os_profile {
    computer_name_prefix = "user15vm1"
...
network_profile {
        ...
        load_balancer_backend_address_pool_ids = [azurerm_lb_backend_address_pool.user15-bpepool1.id]
